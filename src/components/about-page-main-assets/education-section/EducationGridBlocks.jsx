...
function EducationGridBlocks() {
    ...
    const { displayMode, imageMode } = useSelector(state => state.displayValue);

    return (
        <>
            <div className="w-full  md:w-[500px] lg:w-[700px] h-auto lg:h-96 rounded-3xl overflow-hidden">
                <img src={YorkU_Main_Entrance} />
            </div>

            <div className="w-[550px] h-96 p-1 md:p-6 text-center flex flex-col items-center rounded-3xl text-white border-white border-2 border-solid bg-gradient-to-b from-light-gray to-very-dark-blue">
            ...
            <div className={`h-72 w-[450px] ${(displayMode > 2) || (imageMode > 2) ? 'hidden' : 'hidden md:inline-block'} rounded-2xl overflow-hidden`}>
            ...
            <div className={`h-56 w-[420px] ${(displayMode > 2) || (imageMode > 2) ? 'hidden' : 'hidden md:inline-block'} rounded-2xl overflow-hidden`}>
