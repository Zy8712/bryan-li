        ...
        <>
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mt-8">
                ...
                <div className="w-[500px] h-14 px-1 flex justify-between items-center rounded-full border-light-gray border-2 border-solid">
                    <button aria-label="Site Display Default Settings" onClick={() => dispatch(setDisplayMode(1))} disabled={displayMode == 1 ? true : false}
                    ...
                    <button aria-label="Site Display Custom Settings" onClick={() => dispatch(setDisplayMode(2))} disabled={displayMode == 2 ? true : false}
                    ...
                    <button aria-label="Site Display Performance Settings" onClick={() => dispatch(setDisplayMode(3))} disabled={displayMode == 3 ? true : false}
                    ...
                    <button aria-label="Site Display Minimal Settings" onClick={() => dispatch(setDisplayMode(4))} disabled={displayMode == 4 ? true : false}
