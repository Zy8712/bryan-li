        ...
        <>
            <div className="flex justify-between items-center mt-5">
                ...
                <div className='flex justify-between items-center w-56 h-12 px-1 border-light-gray border-2 border-solid rounded-full'>
                    <button aria-label="Enable Animated Icons" onClick={() => dispatch(toggleAnimatedIcons())} disabled={animatedIcons ? true : false}
                    ...
                    <button aria-label="Disable Animated Icons" onClick={() => dispatch(toggleAnimatedIcons())} disabled={animatedIcons ? false : true}
