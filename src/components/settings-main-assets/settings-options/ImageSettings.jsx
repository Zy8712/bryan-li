        ...
        <>
            <div className="flex justify-between items-center mt-5">
                ...
                <div className="flex justify-between items-center rounded-full px-1 w-[450px] h-12 border-2 border-light-gray border-solid">
                    <button aria-label="Default Image Settings Option" onClick={() => dispatch(setImageMode(1))} disabled={imageMode == 1 ? true : false}
                    ...
                    <button aria-label="Low Res. Image Settings Option" onClick={() => dispatch(setImageMode(2))} disabled={imageMode == 2 ? true : false}
                    ...
                    <button aria-label="Hide Some Image Settings Option" onClick={() => dispatch(setImageMode(3))} disabled={imageMode == 3 ? true : false}
                    ...
                    <button aria-label="Hide Most Image Settings Option" onClick={() => dispatch(setImageMode(4))} disabled={imageMode == 4 ? true : false}
