        ...
        <>
            <div className="flex justify-between items-center mt-5">
                ...
                <div className='flex justify-between items-center w-56 h-12 px-1 border-light-gray border-2 border-solid rounded-full'>
                    <button onClick={() => dispatch(toggleHomeAnimatedImage())} disabled={animatedHomeImage ? true : false}
                    ...
                    <button onClick={() => dispatch(toggleHomeAnimatedImage())} disabled={animatedHomeImage ? false : true}
