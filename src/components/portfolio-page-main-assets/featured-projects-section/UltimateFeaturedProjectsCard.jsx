...
function UltimateFeaturedProjectCard(props) {
    ...
    return (
        <>
            <div className="w-[1100px] h-[500px] relative flex mb-5 rounded-xl bg-gradient-to-tr from-gradient-blue to-gradient-purple border-white border-8 border-solid">

                <div className="absolute -top-9 left-3 w-[268px] h-12 p-1 flex justify-center items-center text-center overflow-hidden rounded-full bg-gradient-to-tr from-gradient-blue to-gradient-purple">
                ...
                <div className="w-1/2 h-full pt-6 px-6 pb-4 flex flex-col items-center text-center">
                    <div className="w-full h-full relative">
                        ...
                        <p className="text-white text-md font-semibold mb-1">Project Status:&nbsp;
                            <span className="text-fem-intermediate uppercase">{props.projectStatus}</span>
                        </p>
                        <p className="text-white text-md font-semibold">Project Source:&nbsp;
                            <a href={props.projectSourceLink}
                        ...
                        <div className="absolute flex bottom-0 w-full h-14">
                            ...
                            <div className="w-1/2 h-full flex justify-center items-center text-4xl text-white">
                                <a href={props.projectPreviewLink}
                                    className="flex justify-center items-center link-custom3">
