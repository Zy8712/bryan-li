        ...
        <div className="h-[211.67px] text-white flex flex-col relative bg-gradient-to-b from-interactive-rating-light-gray to-interactive-rating-very-dark-blue">
          ...
          <div className="w-full h-[50px] flex absolute bottom-0">
            <div className="w-1/2 h-full flex justify-center items-center">
              <a className="link-custom" href="https://github.com/Zy8712/frontend-mentor-challenges/tree/main/interactive-rating-component/my-work" target="_blank"><i className="lab la-github mr-1"></i>GitHub Repo</a>
            </div>
            <div className="w-1/2 h-full flex justify-center items-center">
              <a className="link-custom2" href="https://frontend-mentor-challenges-pi-sage.vercel.app/interactive-rating-component/my-work/index.html" target="_blank"><i className="las la-external-link-alt mr-1"></i>Preview</a>
            </div>
          </div>
        </div>
